...
const TodoList = () => {
  ...
  return (
    <div className="flex max-w-full justify-center">
      <div className="bg-gray-950 rounded-lg p-4 w-3/4">
        <div className="mb-6">
          <button
            onClick={logOut}
        ...
        <h1 className="text-4xl bold mb-4 text-cyan-50 text-center">TO-DO LIST</h1>
        <div className="mb-6 flex items-center space-x-4">
          ...
          <button
            onClick={addList}
            className="bg-green-400 hover:bg-green-600 text-white py-2 px-4 rounded-md transition-colors"
          >
            Add List
          </button>
        </div>
        ...
        <DragDropContext onDragEnd={onDragEnd}>
          <div className="grid grid-cols-3 gap-4">
            {lists.map((list) => (
              <div key={list.id} className="bg-indigo-400 p-6 rounded-lg">
                ...
                <div className="mt-4">
                  ...
                  <button
                    ...
                    className="bg-indigo-800 hover:bg-indigo-900 text-white py-2 px-4 rounded-md transition-colors mt-2"
                  >
                    Add Task
                  </button>
                </div>
